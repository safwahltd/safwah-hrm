        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li class="collapsed">
                <a class="m-link" href="{{route('employee.attendance.list')}}">
                    <i class="icofont-home fs-5"></i> <span> Attendance </span>
                </a>
            </li>
            <li class="collapsed">
                <a class="m-link" href="{{route('employee.attendance.report')}}">
                    <i class="icofont-home fs-5"></i> <span> Attendance Report</span>
                </a>
            </li>
            <li class="collapsed">
                <a class="m-link" href="{{route('employee.dashboard')}}">
                    <i class="icofont-home fs-5"></i> <span> Salary </span>
                </a>
            </li>
            <li class="collapsed">
                <a class="m-link" href="{{route('employee.dashboard')}}">
                    <i class="icofont-home fs-5"></i> <span> Holidays </span>
                </a>
            </li>
            <li class="collapsed">
                <a class="m-link" href="{{route('employee.dashboard')}}">
                    <i class="icofont-home fs-5"></i> <span> Leave </span>
                </a>
            </li>

            <li class="collapsed">
                <a class="m-link" data-bs-toggle="collapse" data-bs-target="#client-Components" href="#"><i
                        class="icofont-user-male"></i> <span>Account Details</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu collapse" id="client-Components">
                    <li><a class="ms-link" href="#"> <span>General Info</span></a></li>
