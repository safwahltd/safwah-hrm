            ...
            <div class="card bg-secondary-subtle teacher-card mb-3">
                <div class="card-body  d-flex teacher-fulldeatil">
                    <div class="profile-teacher pe-xl-4 pe-md-2 pe-sm-4 pe-0 text-center w220 mx-sm-0 mx-auto">
                        ...
                        @else
                            <img id="imagePreview" src="{{asset('/')}}admin/assets/images/lg/{{ $user->userInfo->gender == '1' ? 'avatar5.jpg':''}}{{$user->userInfo->gender == '2' ? 'avatar2.jpg':''}}{{$user->userInfo->gender == '3' ? 'avatar4.jpg':''}}" alt="" class="avatar xl rounded-circle img-thumbnail shadow-sm">
                        @endif
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="row">
                                <div class="card bg-secondary-subtle">
                                    <div class="row">
                                        <div class="text-end">
                                            <button type="button" class="btn p-0 text-end" data-bs-toggle="modal" data-bs-target="#generalInfo"><i class="icofont-edit text-primary fs-6"></i></button>
                                        </div>
                                        <div class="col-md-6">
