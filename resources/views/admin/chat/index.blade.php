    ...
    <div class="row g-0">
        <div class="col-12 d-flex">
            ...
            <div class="card card-chat-body border-0  w-100 px-4 px-md-5 py-3 py-md-4">
                ...
                <!-- Chat: Footer -->
                <div class="chat-message bg-white pt-2" >
                    <div class="row">
                        <div class="col-1 my-3">
                            <a href="" class="mx-2"><i class="fa-solid fa-paperclip"></i></a>
                        </div>
                        <div class="col-10">
                            <textarea class="form-control" placeholder="Enter text here..."></textarea>
                        </div>
                        <div class="col-1 justify-content-between my-3">
                            <a href="" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i></a>
                        </div>
                    </div>
