<div class="sidebar px-4 py-4 py-md-5 me-0" style="background-color: #1a1d20">
    <div class="d-flex flex-column h-100" >
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            @endif
            @if(auth()->user()->hasPermission('admin salary index') || auth()->user()->hasPermission('admin salary payment index') || auth()->user()->hasPermission('admin expense index'))
                <li class="collapsed">
            ...
            @if(auth()->user()->hasPermission('admin daily report') || auth()->user()->hasPermission('admin leave report') || auth()->user()->hasPermission('admin asset report')
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#client-Components" href="#"><i class="icofont-search-document fs-5 "></i> <span>Reports</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse
                    ...
                    {{ Request::route()->getName() == 'admin.asset.report' ? 'show':'' }}" id="client-Components">
